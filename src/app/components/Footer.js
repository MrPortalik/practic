...
import { dateGet } from '@/public/scripts/dateGet'
    ...
    <footer>
        <div className="container">
            <div className="copyright">
                ...
                <p className="dateElement">@ {dateGet()} - All rights reserved</p>
            </div>
